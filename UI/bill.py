...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.finishLayout = QtWidgets.QHBoxLayout()
        self.finishLayout.setObjectName("finishLayout")
        spacerItem2 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.finishLayout.addItem(spacerItem2)
        self.pushButton_confirm = QtWidgets.QPushButton(self.tab_income)
        self.pushButton_confirm.setObjectName("pushButton_confirm")
        self.finishLayout.addWidget(self.pushButton_confirm)
        spacerItem3 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.finishLayout.addItem(spacerItem3)
        self.incomeLayout.addLayout(self.finishLayout)
